...
function users(state =[], action){
  ...
  if(action.type === "REMOVE_USER"){
    let newUserArray = [...state]
    return newUserArray.splice(1);
  }
  return state;
}
...
const rootReducer = combineReducers({
  currentCount, users, specialText, videoURL, currentUserSort, videoScale, searchText, currentTemp, isLoading, currentCity
});
